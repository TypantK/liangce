...
STRATEGY_EXPLANATIONS = {
    ...
    "RSI 超买超卖": {
        "summary": "RSI 在 0-100 波动，低于 30 说明「跌过头了」该抄底，高于 70 说明「涨过头了」该跑。",
        "buy_logic": "RSI 跌破超卖线（默认 30），市场恐慌抛售过头，价格大概率会反弹。在恐慌中买入。",
        "sell_logic": "RSI 升破超买线（默认 70），市场兴奋过度，该落袋为安。或者触发跟踪止损——股价从最高点回落超过一定幅度就自动卖。",
